...
class SubjectController extends Controller
{
     ...
     */
    public function index($standard_id)
    {
        $data['standard'] = Standard::find($standard_id);
        $data['items'] = Subject::where('standard_id', $standard_id)->paginate(20)->withQueryString();
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request, $standard_id)
    {
        $request->validate([
            'name' => 'required'
        ]);
